...
const R: f32 = 8.314_463; // molar gas constant, J/mol/K
...
pub fn mixing_ratio(temperature: Temperature, station_pressure: Pressure) -> Fraction {
    ...
    Fraction::new(g_kg / 1000., Decimal)
}
...
pub fn lcl_temperature(temperature_below_lcl: Temperature, dewpoint: Temperature) -> Temperature {
    ...
    Temperature::new(value, Kelvin)
}

// an approximation
pub fn theta_e(
    temperature_below_lcl: Temperature,
    ...
    Temperature::new(theta_e, Kelvin)
}
